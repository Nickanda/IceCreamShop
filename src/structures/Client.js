...
module.exports = class DiscordClient extends Client {
  constructor(options) {
    ...
    this.databaseClient = new MongoClient(`mongodb://${this.config.database.username}:${this.config.database.password}@localhost:27017?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&ssl=false`, { useNewUrlParser: true });
